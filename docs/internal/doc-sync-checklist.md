...
| 必填章节 | `grep -E "^## (测试结果|测试范围|合规审查)" VERIFICATION.md` | 包含所有必填章节 |
...
| 检查项 | 检查方法 | 通过标准 |
|--------|----------|----------|
| Feature 关联 | `grep -E "Feature: [A-Z]+-[0-9]+" VERIFICATION.md` | 关联到 Feature 编号 |
| Commit 关联 | `grep -E "Commit: [a-f0-9]{7,}" VERIFICATION.md` | 关联到 Commit Hash |
| 任务关联 | `grep -E "Tasks?: (T-[0-9]+,?)+" VERIFICATION.md` | 关联到 Task 编号 |
